                ...
                <tbody class="align-middle text-end">
                    <?php 
                        if($list_cart){ 
                            ...
                            extract($list_cart[$i]);
                            $product = get_one_product_by_id($id);
                    ?>
                    <tr class="align-middle">
                        <td class="text-start d-flex align-items-center"> 
                            <div><img width="50" src="<?=URL_IMAGE_PRODUCT.$product['imgDefault']?>" alt="<?=$product['imgDefault']?>"></div>
                            <div>
                                <span class="text-danger ms-2 fw-bold"><?= $product['name'] ?> </span>
                            </div>
                        </td>
                        ...
                        <td>
                            ...
                            <div class="btn-group d-flex align-items-center mx-auto w-25 justify-content-center">
                                <button name="quantity" value="<?=$quantity-1?>" class="btn btn-outline-danger btn-sm" <?php if($quantity==1) echo'disabled'?>><i class="fas fa-minus"></i></button>
                                    <span class="mx-2"> <?= $quantity ?> </span>
                                <button name="quantity" value="<?=$quantity+1?>" class="btn btn-outline-danger btn-sm" <?php if($quantity==$product['quantity']) echo'disabled'?>><i class="fas fa-plus"></i></button>
                            </div>
                            </form>
                        </td>
                        <td class="text-end"><?= number_format($quantity*$product['price']) ?> đ</td>
                        <td class="text-end">
                            <button name="removeCart" value="<?=$i?>" type="submit" class="btn btn-sm border text-hover">
